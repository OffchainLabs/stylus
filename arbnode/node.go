...
func GetBlockChain(chainDb ethdb.Database, arbDb ethdb.KeyValueWriter, cacheConfig *core.CacheConfig, chainConfig *params.ChainConfig, nodeConfig *Config) (*core.BlockChain, error) {
	engine := arbos.Engine{
		IsSequencer: true,
	}
...
func WriteOrTestBlockChain(chainDb ethdb.Database, arbDb ethdb.KeyValueWriter, cacheConfig *core.CacheConfig, initData statetransfer.InitDataReader, chainConfig *params.ChainConfig, nodeConfig *Config, accountsPerSync uint) (*core.BlockChain, error) {
	...
	return GetBlockChain(chainDb, arbDb, cacheConfig, chainConfig, nodeConfig)
}
