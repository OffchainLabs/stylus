...
func main() {
	...
	if lastBlockStateRoot != (common.Hash{}) {
		...
		newBlock, _, err = arbos.ProduceBlock(message.Message, message.DelayedMessagesRead, lastBlockHeader, statedb, nil /* no arbDb */, chainContext, chainConfig, batchFetcher)
		if err != nil {
			panic(err)
		}
