...
func mainImpl() int {
	...
	chainDb, l2BlockChain, err := openInitializeChainDb(ctx, stack, arbDb, nodeConfig, new(big.Int).SetUint64(nodeConfig.L2.ChainID), arbnode.DefaultCacheConfigFor(stack, &nodeConfig.Node.Caching))
