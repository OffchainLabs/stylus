    ...
    fn from_module(module: Module, mut store: Store, env: WasmEnv<E>) -> Result<Self> {
        ...
        let mut imports = imports! {
            "vm_hooks" => {
                ...
                "smod" => func!(host::smod),
                "exp" => func!(host::exp),
                "addmod" => func!(host::addmod),
                "mulmod" => func!(host::mulmod),
                "expmod" => func!(host::expmod),
                "sign_extend" => func!(host::sign_extend),
...
pub fn module(wasm: &[u8], compile: CompileConfig) -> Result<Vec<u8>> {
    ...
    let mut imports = imports! {
        "vm_hooks" => {
            ...
            "div" => stub!(|_: u32, _: u32, _: u32|),
            "sdiv" => stub!(|_: u32, _: u32, _: u32|),
            "mod_" => stub!(|_: u32, _: u32, _: u32|),
            "smod" => stub!(|_: u32, _: u32, _: u32|),
            "exp" => stub!(|_: u32, _: u32, _: u32|),
            "addmod" => stub!(|_: u32, _: u32, _: u32, _: u32|),
            "mulmod" => stub!(|_: u32, _: u32, _: u32, _: u32|),
            "expmod" => stub!(|_: u32, _: u32, _: u32, _: u32|),
            "sign_extend" => stub!(|_: u32, _: u32, _: u32|),
