...
pub fn pricing_v1(op: &Operator, tys: &HashMap<SignatureIndex, FunctionType>) -> u64 {
    ...
    let ink = match op {
        ...
        dot!(
            ...
            I8x16SubSatU, I8x16MinS, I8x16MinU, I8x16MaxS, I8x16MaxU,
            I8x16AvgrU, I8x16RelaxedLaneselect, 
            ...
            I16x8MinU, I16x8MaxS, I16x8MaxU, I16x8ExtMulLowI8x16S, I16x8RelaxedLaneselect,
            I16x8AvgrU, I16x8RelaxedQ15mulrS, I16x8DotI8x16I7x16S, 
            ...
            F32x4RelaxedFma, F32x4RelaxedFnma, F32x4RelaxedDotBf16x8AddF32x4,
            ...
            F64x2RelaxedFma, F64x2RelaxedFnma, 
            ...
            I64x2RelaxedLaneselect, F32x4RelaxedMin, F32x4RelaxedMax,
