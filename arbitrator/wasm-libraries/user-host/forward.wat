...
(module
    ...
    (import "user_host" "arbitrator_forward__contract_footprint" (func $contract_footprint (result i32)))
    (import "user_host" "arbitrator_forward__contract_wasm_size" (func $contract_wasm_size (result i32)))
    ...
    (export "vm_hooks__contract_footprint"     (func $contract_footprint))
    (export "vm_hooks__contract_wasm_size"     (func $contract_wasm_size))
